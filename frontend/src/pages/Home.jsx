...
import { Search, Star, ShieldCheck, Clock, Users, ChevronRight, PlayCircle } from "lucide-react";
    ...
    <div className="overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-extrabold text-white leading-[1.1] mb-6">
              Tìm <span className="text-indigo-400">Gia sư</span> hoàn hảo cho hành trình của bạn.
            </h1>
            <p className="text-lg md:text-xl text-slate-300 mb-10 leading-relaxed">
              Kết nối với các sinh viên và giảng viên giàu kinh nghiệm để nhận sự hướng dẫn 1-1 cá nhân hóa. Thành thạo bất kỳ môn học nào, bất kỳ lúc nào.
            </p>
              ...
              <div className="flex -space-x-2">
                {[1, 2, 3, 4].map((i) => (
                  <div key={i} className="w-8 h-8 rounded-full border-2 border-slate-900 bg-slate-700 overflow-hidden">
                    <ImageWithFallback src={`https://i.pravatar.cc/150?u=${i}`} alt="người dùng" className="w-full h-full object-cover" />
                  </div>
                ))}
              </div>
              <p className="text-sm font-medium">Hơn 10.000 học viên đã tham gia trong học kỳ này</p>
            </div>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-end mb-12">
            <div>
              <h2 className="text-3xl font-bold text-slate-900 mb-4">Khám phá theo chủ đề</h2>
              ...
              >
                <div className="w-12 h-12 bg-white rounded-xl shadow-sm flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                  <div className="w-6 h-6 rounded-md bg-indigo-50 border border-indigo-100 flex items-center justify-center">
                    <span className="text-indigo-600 font-bold text-xs">{cat[0]}</span>
                  </div>
                </div>
      ...
      <section className="py-24 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-slate-900 mb-4">TutorLink hoạt động như thế nào?</h2>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-end mb-12">
            <div>
              <h2 className="text-3xl font-bold text-slate-900 mb-4">Gia sư được đánh giá cao nhất</h2>
              <p className="text-slate-500 max-w-lg">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {tutors.map((tutor) => (
              <div key={tutor.id} className="group bg-white rounded-3xl border border-slate-100 overflow-hidden hover:shadow-2xl hover:shadow-indigo-500/10 transition-all duration-500">
          ...
          <div className="bg-indigo-600 rounded-[40px] p-12 md:p-20 relative overflow-hidden">
            ...
            <div className="relative z-10 text-center max-w-3xl mx-auto">
              ...
              <p className="text-indigo-100 text-lg mb-12">
                Tham gia cùng hàng ngàn học viên đã cải thiện điểm số và sự tự tin với TutorLink.
              </p>
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <Link to="/signup" className="w-full sm:w-auto px-10 py-4 bg-white text-indigo-600 rounded-2xl font-bold text-lg hover:bg-slate-50 transition-all shadow-xl">
                  Bắt đầu miễn phí
                </Link>
                <Link to="/search" className="w-full sm:w-auto px-10 py-4 border-2 border-indigo-400 text-white rounded-2xl font-bold text-lg hover:bg-indigo-500 transition-all">
                  Tìm gia sư
                </Link>
              </div>
            </div>
